...
This document describes how @sebastienrousseau/semantic-release-config is run: who decides what, how
...
@sebastienrousseau/semantic-release-config is **maintainer-led**. As of the current release line it has a single
