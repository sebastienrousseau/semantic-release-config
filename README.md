...
<h1 align="center">@sebastienrousseau/semantic-release-config</h1>

<p align="center">
  Shareable semantic-release configuration rules for automated releases
</p>

<p align="center">
  <a href="https://github.com/sebastienrousseau/semantic-release-config/actions"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/semantic-release-config/ci.yml?branch=main&style=for-the-badge&logo=github" alt="Build Status" /></a>
  <a href="https://www.npmjs.com/package/@sebastienrousseau/semantic-release-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fsemantic-release-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/semantic-release-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  <a href="https://scorecard.dev/viewer/?uri=github.com/sebastienrousseau/semantic-release-config"><img src="https://img.shields.io/ossf-scorecard/github.com/sebastienrousseau/semantic-release-config?style=for-the-badge&label=OpenSSF%20Scorecard&logo=openssf" alt="OpenSSF Scorecard" /></a>
  <a href="https://www.bestpractices.dev/projects/14518"><img src="https://img.shields.io/cii/level/14518?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Automated Releases & Changelogs](#automated-releases--changelogs) — before and after rule comparison
...
Install `@sebastienrousseau/semantic-release-config` as a development dependency:
...
# bun
bun add -d @sebastienrousseau/semantic-release-config
```

### Build from source

```bash
git clone https://github.com/sebastienrousseau/semantic-release-config.git
...
semantic-release resolves a shareable configuration by package name. The plugins this pipeline uses are declared as dependencies, so installing this package installs them.
...
`@sebastienrousseau/semantic-release-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/semantic-release-config` solves this with three deliberate engineering choices:
...
Automates version bumping, CHANGELOG.md generation, GitHub release publishing, and npm releases.
...
### After (@sebastienrousseau/semantic-release-config Enforced)

```javascript
// Automated release via @sebastienrousseau/semantic-release-config
module.exports = require("@sebastienrousseau/semantic-release-config");
```
...
When your release process requires manual gatekeeping, changelog curation by committee, or bespoke manual release approval steps.
