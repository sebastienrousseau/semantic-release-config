...
%global npm_bare      semantic-release-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-semantic-release-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable semantic-release configuration rules for automated releases

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/semantic-release-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/semantic-release-config is a shareable configuration preset with no runtime
