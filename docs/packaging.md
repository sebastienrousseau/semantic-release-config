...
# Packaging @sebastienrousseau/semantic-release-config
...
Runtime dependencies: `@semantic-release/changelog`, `@semantic-release/git`.
These are required because the configuration names them, and a consumer that
did not receive them would get a resolution failure at load time.

Peer dependency: `semantic-release >=23.0.0`.
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/semantic-release-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/semantic-release-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/semantic-release-config/` |
| Homebrew | [`pkg/brew/semantic-release-config.rb`](../pkg/brew/semantic-release-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/semantic-release-config/` |
